...
class User {
  ...
  updateFavoritesFromStorage() {
    const storedFavorites = JSON.parse(localStorage.getItem(`${this.username}-favorites`));
    if (storedFavorites) {
      this.favorites = storedFavorites.map(s => new Story(s));
    }
  }
  ...
  saveFavoritesToStorage() {
    localStorage.setItem(`${this.username}-favorites`, JSON.stringify(this.favorites));
  }
